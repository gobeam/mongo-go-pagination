...
// and sort value
// set sortFirst to true if you want to sort before limit
...
type PagingQuery interface {
	...
	SetSortFirst(sortFirst bool) PagingQuery
}
...
func (paging *pagingQuery) SetSortFirst(sortFirst bool) PagingQuery {
...
func (paging *pagingQuery) Aggregate(filters ...interface{}) (paginatedData *PaginatedData, err error) {
	...
	facetData = setFacetDataInOrder(paging.SortFirst, paging.SortFields, skip, paging.LimitCount)
...
func setFacetDataInOrder(sortFirst bool, sortFields bson.D, skip, limitCount int64) []bson.M {
	var facetData []bson.M
	if sortFirst {
		if len(sortFields) > 0 {
